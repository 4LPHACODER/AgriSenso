...
const LandingPage = () => {
  return <div className="min-h-screen flex flex-col bg-black overflow-hidden">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="relative py-20 bg-gradient-to-b from-gray-900 to-black scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{
          opacity: 0,
          y: 20
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            once: true
              ...
              <div className="space-y-4 mb-8">
                {['High-definition IoT camera', 'Professional installation', 'Real-time monitoring access', 'Cloud storage included', '24/7 technical support', 'Free software updates'].map((feature, index) => <div key={index} className="flex items-center">
      ...
      {/* CTA Section */}
      <section id="contact" className="relative py-20 bg-gradient-to-t from-black via-gray-900 to-black scroll-mt-20">
