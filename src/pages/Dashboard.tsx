...
import { ArrowRightIcon, BarChart2Icon, CalendarIcon, ClipboardCheckIcon, CreditCardIcon, LayoutDashboardIcon, RefreshCwIcon, UsersIcon, TrendingUpIcon, TrendingDownIcon, ThermometerIcon, AlertCircleIcon, ChevronRightIcon, ActivityIcon, HeartPulseIcon, CloudRainIcon, BellIcon, ClockIcon, DropletIcon, InfoIcon } from 'lucide-react';
...
const Dashboard = ({
  ...
  const DashboardOverview = () => <>
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          <div className={`${theme === 'dark' ? 'bg-gray-800/60 border-gray-700/50 hover:bg-gray-800/80' : 'bg-white border-gray-200/70 hover:shadow-xl'} rounded-xl p-4 border shadow-sm transition-all duration-300 cursor-pointer group`}>
            <div className="flex items-center justify-between mb-3">
              <div className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                Total Livestock
              </div>
              <div className={`${theme === 'dark' ? 'bg-blue-500/20 group-hover:bg-blue-500/30' : 'bg-blue-100 group-hover:bg-blue-200'} p-2 rounded-lg transition-colors duration-300`}>
            ...
            <div className={`flex items-center text-xs ${theme === 'dark' ? 'text-green-400' : 'text-green-600'} font-medium`}>
          ...
          <div className={`${theme === 'dark' ? 'bg-gray-800/60 border-gray-700/50 hover:bg-gray-800/80' : 'bg-white border-gray-200/70 hover:shadow-xl'} rounded-xl p-4 border shadow-sm transition-all duration-300 cursor-pointer group`}>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className={`${theme === 'dark' ? 'bg-red-500/20 group-hover:bg-red-500/30' : 'bg-red-100 group-hover:bg-red-200'} p-2 rounded-lg transition-colors duration-300 relative`}>
            ...
            <div className={`flex items-center text-xs ${theme === 'dark' ? 'text-red-400' : 'text-red-600'} font-medium`}>
          ...
          <div className={`${theme === 'dark' ? 'bg-gray-800/60 border-gray-700/50 hover:bg-gray-800/80' : 'bg-white border-gray-200/70 hover:shadow-xl'} rounded-xl p-4 border shadow-sm transition-all duration-300 cursor-pointer group`}>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className={`${theme === 'dark' ? 'bg-yellow-500/20 group-hover:bg-yellow-500/30' : 'bg-yellow-100 group-hover:bg-yellow-200'} p-2 rounded-lg transition-colors duration-300`}>
                <ThermometerIcon size={18} className={theme === 'dark' ? 'text-yellow-400' : 'text-yellow-600'} />
              </div>
            </div>
            <div className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-1`}>
              28°C
            </div>
            <div className={`flex items-center text-xs ${theme === 'dark' ? 'text-yellow-400' : 'text-yellow-600'} font-medium`}>
              <TrendingUpIcon size={12} className="mr-1" />
              <span>+2°C from yesterday</span>
            </div>
          </div>
          <div className={`${theme === 'dark' ? 'bg-gray-900/50 hover:bg-gray-900/70' : 'bg-gray-100 hover:bg-gray-200'} rounded-xl p-5 transition-all duration-300 border ${theme === 'dark' ? 'border-gray-800 hover:border-blue-500/30' : 'border-gray-200 hover:border-blue-300'}`}>
            <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} mb-4 flex items-center`}>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-800/60 border-gray-700/50' : 'bg-white border-gray-200/70'} rounded-xl p-4 border shadow-sm mb-6 transition-colors`}>
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="#" className={`text-xs ${theme === 'dark' ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-700'} font-medium flex items-center transition-colors`}>
            View all
        ...
        <div className="space-y-2">
          ...
          type: 'info'
        }].map((activity, index) => <div key={index} className={`flex items-center p-3 ${theme === 'dark' ? 'hover:bg-gray-700/30' : 'hover:bg-gray-50'} rounded-lg transition-all duration-200 cursor-pointer group`}>
              <div className={`w-2 h-2 rounded-full ${activity.type === 'alert' ? theme === 'dark' ? 'bg-red-400' : 'bg-red-600' : activity.type === 'success' ? theme === 'dark' ? 'bg-green-400' : 'bg-green-600' : theme === 'dark' ? 'bg-blue-400' : 'bg-blue-600'} mr-3 flex-shrink-0 group-hover:scale-125 transition-transform duration-200`}></div>
              <div className="flex-1 min-w-0">
                <div className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} truncate`}>
                  {activity.event}
                </div>
                <div className={`text-xs ${theme === 'dark' ? 'text-gray-500' : 'text-gray-500'} flex items-center mt-0.5`}>
                  <ClockIcon size={10} className="mr-1" />
                  {activity.time}
                </div>
              </div>
              <ChevronRightIcon size={16} className={`${theme === 'dark' ? 'text-gray-600 group-hover:text-gray-400' : 'text-gray-400 group-hover:text-gray-600'} transition-colors flex-shrink-0`} />
            </div>)}
        </div>
      </div>
    </>;
  ...
  const Analytics = () => <div className="mb-6 space-y-6">
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-800/40 backdrop-blur-xl border-gray-700/50' : 'bg-white backdrop-blur-xl border-gray-200/70'} rounded-xl shadow-lg overflow-hidden border transition-colors p-6`}>
        <div className="flex items-center mb-6">
          <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-green-500/20' : 'bg-green-100'} mr-3`}>
            <HeartPulseIcon size={24} className={theme === 'dark' ? 'text-green-400' : 'text-green-600'} />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className={`${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'} rounded-lg p-4 transition-colors`}>
            <div className="flex justify-between items-center mb-2">
              ...
              <div className={`flex items-center text-sm ${theme === 'dark' ? 'text-red-400' : 'text-red-600'} font-medium`}>
                <TrendingDownIcon size={16} className="mr-1" />
                <span>-8%</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-3">
            <div className={`${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'} rounded-xl p-5 transition-colors border ${theme === 'dark' ? 'border-gray-800' : 'border-gray-200'}`}>
              <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} mb-4 flex items-center`}>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-800/40 backdrop-blur-xl border-gray-700/50' : 'bg-white backdrop-blur-xl border-gray-200/70'} rounded-xl shadow-lg overflow-hidden border transition-colors p-6`}>
        <div className="flex items-center mb-6">
          <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-blue-500/20' : 'bg-blue-100'} mr-3`}>
          ...
          <div>
            ...
            <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
              7-day forecast and impact assessment
            </p>
          </div>
        </div>
        ...
        <div className={`${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'} rounded-xl p-5 transition-colors border ${theme === 'dark' ? 'border-gray-800' : 'border-gray-200'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className={`p-4 ${theme === 'dark' ? 'bg-blue-900/20 border-blue-700/30 hover:bg-blue-900/30' : 'bg-blue-50 border-blue-200 hover:bg-blue-100'} rounded-xl border transition-all duration-300 cursor-pointer`}>
              <div className={`text-sm font-medium mb-2 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-800'} flex items-center`}>
                <ThermometerIcon size={14} className="mr-1.5" />
            ...
            <div className={`p-4 ${theme === 'dark' ? 'bg-blue-900/20 border-blue-700/30 hover:bg-blue-900/30' : 'bg-blue-50 border-blue-200 hover:bg-blue-100'} rounded-xl border transition-all duration-300 cursor-pointer`}>
              <div className={`text-sm font-medium mb-2 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-800'} flex items-center`}>
                <DropletIcon size={14} className="mr-1.5" />
                Humidity Effects
              </div>
              <div className={`text-xs ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <div className={`p-4 ${theme === 'dark' ? 'bg-blue-900/20 border-blue-700/30 hover:bg-blue-900/30' : 'bg-blue-50 border-blue-200 hover:bg-blue-100'} rounded-xl border transition-all duration-300 cursor-pointer`}>
              <div className={`text-sm font-medium mb-2 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-800'} flex items-center`}>
                <CloudRainIcon size={14} className="mr-1.5" />
                Rainfall Impact
              </div>
              <div className={`text-xs ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-800/40 backdrop-blur-xl border-gray-700/50' : 'bg-white backdrop-blur-xl border-gray-200/70'} rounded-xl shadow-lg overflow-hidden border transition-colors p-6`}>
        <div className="flex items-center mb-6">
          <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-purple-500/20' : 'bg-purple-100'} mr-3`}>
            <AlertCircleIcon size={24} className={theme === 'dark' ? 'text-purple-400' : 'text-purple-600'} />
          </div>
          <div>
            <h2 className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
              Alert Analysis
            ...
            <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
              System-wide alert monitoring and trends
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className={`${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'} rounded-lg p-4 transition-colors`}>
            ...
            <div className="space-y-5">
              <div className="group">
                ...
                <div className={`text-xs ${theme === 'dark' ? 'text-green-400' : 'text-green-600'} flex items-center font-medium`}>
            ...
            <div className={`mt-5 pt-5 border-t ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-200'}`}>
              <Link to="/dashboard/alerts" className={`w-full flex items-center justify-center py-3 ${theme === 'dark' ? 'bg-purple-600 hover:bg-purple-700' : 'bg-purple-600 hover:bg-purple-700'} text-white rounded-xl transition-all duration-300 text-sm font-medium shadow-lg hover:shadow-xl active:scale-95`}>
