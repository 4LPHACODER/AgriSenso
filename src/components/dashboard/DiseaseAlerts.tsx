...
const alerts: Alert[] = [
  {
    ...
    severity: 'medium',
    time: '2 hours ago',
    image: '/src/assets/images/Pen3.png',
    penId: 3
  },
  {
    id: 2,
    title: 'Elevated Temperature Detected',
    description: 'Temperature spike in Pen 1, possible fever in 2 pigs',
    severity: 'high',
    time: '1 hour ago',
    image: '/src/assets/images/Pen1.png',
    penId: 1
  },
  {
    id: 3,
    title: 'Reduced Feeding Activity',
    description: 'Feeding activity dropped below normal in Pen 2',
    severity: 'medium',
    time: '30 minutes ago',
    image: '/src/assets/images/Pen2.png',
    penId: 2
  },
  {
    id: 4,
    title: 'Possible Lameness Detected',
    description: 'Unusual movement patterns in Pen 4',
    severity: 'low',
    time: '10 minutes ago',
    image: '/src/assets/images/Pen4.png',
    penId: 4
  }
];
...
const DiseaseAlerts = ({ showDetailed = false }: DiseaseAlertsProps) => {
  const [selectedImage, setSelectedImage] = useState<Alert | null>(null);
  const openImage = (alert: Alert) => {
