...
const notifications: Notification[] = [
  ...
  },
  {
    id: 4,
    type: 'action',
    title: 'Monitor piglet health',
    description: 'Piglets in Pen 2 show reduced activity. Check for possible illness.',
    time: '20 minutes ago',
    priority: 'medium',
  ...
  },
  {
    id: 5,
    type: 'action',
    title: 'Inspect flooring',
    description: 'Slippery surface detected in Pen 4. Inspect and clean to prevent injuries.',
    time: '10 minutes ago',
    priority: 'high',
    icon: <ShieldIcon size={16} />,
...
const FarmerNotifications = ({ showDetailed = false }: FarmerNotificationsProps) => {
